...
class MCTSEnvironment:
    ...
    def _terminate_and_evaluate(self):
        ...
        # long continuations → vllm hosted backends
        outputs1 = _vllm_generate(TEACHER_MODEL_IDS[0], continuation_prompts, self.params1)
        outputs2 = _vllm_generate(TEACHER_MODEL_IDS[1], continuation_prompts, self.params2)
        outputs3 = _vllm_generate(TEACHER_MODEL_IDS[2], continuation_prompts, self.params3)
