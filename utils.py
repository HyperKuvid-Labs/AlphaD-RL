...
def generate_best_solution(prompt: str, tm1, tm2, tm3, tok1, tok2, tok3, params1, params2, params3):
  prompt = (
    ...
    "Output STRICTLY raw Python source code.\n"
    "DO NOT include explanations, comments, markdown, backticks, headings, or extra text.\n"
    "DO NOT echo the prompt.\n"
    "Your entire response MUST be directly executable Python.\n"
    "If unsure, still produce best-effort valid Python code.\n"
    "\n"
    "[TASK]\n"
    + prompt + "\n"
    "\n"
    ...
    "- The file must be fully self-contained and runnable.\n"
    ...
    "\n"
    "[OUTPUT FORMAT]\n"
    "Return ONLY valid Python code. Any non-code text is forbidden."
  )
